        ...
        <div class="tengah">
          <div class="head-depan tengah">
            <div class="row">
              ...
              <div class="col-md-11">
                <h1 class="judul-head">Sistem Informasi Geografis ApotekKu</h1>
                <p><i class="fa fa-map-marker fa-fw"></i> Sistem Informasi yang memuat data apotek dan persediaan obat</p>
              </div>
            </div>
    ...
    <nav class="navbar navbar-default navbar-utama" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="data.php"><i class="fa fa-list-ul"></i> DATA APOTEK</a></li>
            <li><a href="data1.php"><i class="fa fa-list-ul"></i> DATA OBAT</a></li>
            <li><a href="peta.php"><i class="fa fa-map-marker"></i> PETA PERSEBARAN APOTEK</a></li>
